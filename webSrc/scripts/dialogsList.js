...
var callback2 = function(){
    globls.pnjs.martin.currentIndex = 2;
    globals.dialogManager.stop(true,false);
...
function setDialog(langue){
    switch(langue){
        ...
        case 1:
            globals.dialogs.pnjTestDialogs = ["hi! I'm a test. You can choose between one and two. kjfkjshdk hdf jkhsd kjh fskj sdfkjhdkh kjsdfh kjdsfh kjdsh kj fkdhj skjh ksj hhkfsjh ksdfjh kjdhf kjhfskjshf kjsfh kjh fkjhsf kjh fkjh fj fskjh fsdkjh sjh fdsjkh dkjh fjhkdkj fdskjh ","you chose option 1","you chose option 2"];
            break;
                 }
}
