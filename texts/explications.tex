...
Le joueur incarne Candide et peut se promener dans les décors inspirés de \textit{Candide}. Il peut avec les pnjs présents dans les décors et faire des combats avec certains d'entre eux.   
%lexique
sources : \
