...
\begin{itemize}
\item \textbf{isLast} : Booléen servant à fermer le dialogue s'il est complétement affiché.
...
Certains éléments qui ont été programmés mériteraient d'être réécrits avec les connaissances acquises lors de ce projets. En effet, les premiers programmes ont été créés en découvrant Phaser, ils n'exploitent donc pas forcément toutes les fonctionnalités Phaser qui permettent d'avoir un code propre et efficace.\\
