...
Cette state sert uniquement à afficher du texte. Une fonction est passée en argument lorsqu'on fait appel à cette state qui l'exécutera. Cette state est une alternative aux cinématiques, trop difficiles à programmer.  
\subsection{Joueur}
