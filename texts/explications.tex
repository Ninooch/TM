...
la méthode \textit{startBattleDesc()} est utilisée dans les phases de combats et gère les descriptions automatiquement, c'est à dire que le joueur n'a pas à intervenir pour que le texte change. \\
